 ...
 * @return      None
 *
 * @details     The WDT_IRQHandler is default IRQ of WDT, declared in startup_M433.s.
 */
...
int main(void)
{
    ...
    /*
     * There is a M433 issue that wakeup interrupt controller (WIC) will stay
     ...
     *
     * If keep WDT reset function during power down is required, force M433 to
     ...
     * power down mode.
     *
     * Please check the section "WDT reset under Power-down mode" in M433 errata
