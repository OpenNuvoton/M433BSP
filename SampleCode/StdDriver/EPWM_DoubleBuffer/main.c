...
void EPWM0P0_IRQHandler(void)
{
    ...
    if(toggle == 0)
    {
        ...
        EPWM_SET_CMR(EPWM0, 0, 79);
    }
    else
    {
        EPWM_SET_CNR(EPWM0, 0, 799);
        EPWM_SET_CMR(EPWM0, 0, 399);
    }
    toggle ^= 1;
...
int32_t main(void)
{
    ...
    /*
        ...
        |<-        CNR + 1  clk     ->|  CNR + 1 = 799 + 1 CLKs
                       |<-CMR+1 clk ->|  CMR + 1 = 399 + 1 CLKs
                                      |<-   CNR + 1  ->|  CNR + 1 = 399 + 1 CLKs
                                               |<CMR+1>|  CMR + 1 = 79 + 1 CLKs
         ______________                ____           ______
      __|     400      |______400_____| 80 |___320___|       EPWM waveform
    ...
    */
    ...
    /*
      ...
      Period = 144 MHz / (1 * (799 + 1)) = 180000 Hz
      Duty ratio = (399 + 1) / (799 + 1) = 50%
    */
    // EPWM0 channel 0 frequency is 180000Hz, duty 50%,
    EPWM_ConfigOutputChannel(EPWM0, 0, 180000, 50);
