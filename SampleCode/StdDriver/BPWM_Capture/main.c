...
void CalPeriodTime(BPWM_T *BPWM, uint32_t u32Ch)
{
    ...
    u32TotalPeriod = u16HighPeriod + u16LowPeriod;

    printf("\nBPWM generate: \nHigh Period=21599 ~ 21601, Low Period=50399 ~ 50401, Total Period=71999 ~ 72001\n");
    printf("\nCapture Result: \nRising Time = %d, Falling Time = %d \nHigh Period = %d, Low Period = %d, Total Period = %d.\n\n",
           u16RisingTime, u16FallingTime, u16HighPeriod, u16LowPeriod, u32TotalPeriod);

    if((u16HighPeriod < 21599) || (u16HighPeriod > 21601) || (u16LowPeriod < 50399) || (u16LowPeriod > 50401) || (u32TotalPeriod < 71999) || (u32TotalPeriod > 72001))
...
int32_t main(void)
{
    ...
    while(1)
    {
        ...
        /* Assume BPWM output frequency is 250Hz and duty ratio is 30%, user can calculate BPWM settings by follows.
           ...
           BPWM clock source frequency = PCLK = 72000000
        ...
        */
        ...
        /* If input minimum frequency is 250Hz, user can calculate capture settings by follows.
           ...
           In capture mode, user should set CNR to 0xFFFF to increase capture frequency range.

           The unit time of counter = 1/(72000000/4) = 55.555ns
           Capture period for BPWM1 = 4ms/55.555ns = 72000
           Prescale value is 3 : prescaler = 4
        */

        /* set BPWM0 channel 0 capture configuration */
        BPWM_ConfigCaptureChannel(BPWM0, 0, 55, 0);
