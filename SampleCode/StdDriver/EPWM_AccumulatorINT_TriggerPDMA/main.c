...
int32_t main(void)
{
    ...
    printf("  to g_u32Period array content, 31999(0x7CFF), by PDMA.\n");
    ...
    /* Assume EPWM output frequency is 300Hz and duty ratio is 30%, user can calculate EPWM settings by follows.
       ...
       EPWM clock source frequency = PLL = 144000000
       (CNR+1) = EPWM clock source frequency/prescaler/EPWM output frequency
               = 144000000/8/300 = 60000
               Note: CNR is 16 bits, so if calculated value is larger than 65536, user should increase prescale value.
       CNR = 59999
       duty ratio = 30% ==> (CMR+1)/(CNR+1) = 30%
       CMR = 17999
       Prescale value is 7 : prescaler= 8
    */
    ...
    /* Set source address as g_u32Period array(increment) and destination address as EPWM1 channel 0 period register(no increment) */
    ...
    printf("\n\nEPWM1 channel 0 period register is updated to %d(0x%x)\n",EPWM_GET_CNR(EPWM1, 0),EPWM_GET_CNR(EPWM1, 0));
