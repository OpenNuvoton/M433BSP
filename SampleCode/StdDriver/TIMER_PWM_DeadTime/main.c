...
void SYS_Init(void)
{
    ...
    SYS->GPA_MFPH |= SYS_GPA_MFPH_PA11MFP_TM0_EXT | SYS_GPA_MFPH_PA10MFP_TM1_EXT;
...
int main(void)
{
    ...
    printf("    - Timer0 PWM_CH0 on PB.5, PWM_CH1 on PA.10\n\n");
    ...
    printf("# I/O configuration:\n");
    printf("    - Timer1 PWM_CH0 on PB.4, PWM_CH1 on PA.11\n\n");
