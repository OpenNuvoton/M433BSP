 ...
 *           a vendor driver. This sample requires a M433 USB device running
...
int32_t main(void)
{
	...
	if (!lbk_device_is_connected())
		printf("Waitng for M433 Vendor Loopback device be connected...\n");
	...
	while (1)
	{
		...
		printf("\n\nWaitng for M433 Vendor Loopback device be connected...\n");
		usbh_memory_used();
	}
}
