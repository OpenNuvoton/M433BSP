 ...
 * @file     system_M433.c
 * @version  V1.000
 * @brief    CMSIS Cortex-M4 Core Peripheral Access Layer Source File for M433
 *
...
void SystemInit (void)
{
    ...
    /* Set access cycle for CPU @ 144MHz */
    FMC->CYCCTL = (FMC->CYCCTL & ~FMC_CYCCTL_CYCLE_Msk) | (7 << FMC_CYCCTL_CYCLE_Pos);
