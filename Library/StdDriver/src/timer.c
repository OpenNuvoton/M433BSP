/**************************************************************************//**
 * @file     timer.c
 * @brief    M433 Timer Controller(Timer) driver source file
 *
...
/**
  ...
  * @param[in] u32DropCount This parameter has no effect in M433 series BSP
  * @param[in] u32Timeout This parameter has no effect in M433 series BSP
