 ...
 * @file     clk.c
 * @version  V3.00
 * @brief    M433 series CLK driver source file
 *
...
/**
  ...
  * @param[in]  u32Hclk is HCLK frequency. The range of u32Hclk is running up to 144MHz.
  * @return     HCLK frequency
...
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    ...
    /* The range of u32Hclk is running up to 144 MHz */
    if(u32Hclk > FREQ_144MHZ)
    {
        u32Hclk = FREQ_144MHZ;
    }
